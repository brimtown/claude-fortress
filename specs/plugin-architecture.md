...
When user provides explicit name that has an existing save:
- **User-provided name**: Loads existing save (no suffix added)
- **Auto-generated name**: Adds random suffix on collision to avoid overwriting
